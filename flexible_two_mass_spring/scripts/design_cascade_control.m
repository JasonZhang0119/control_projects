...
% 目标：利用零极点对消处理电学极点 (约 -306.2 rad/s)
% ========================================================
target_bw_cur = 2000; % 设定电流环带宽 (rad/s)

% 自动提取电学极点 (R/L)
% 电流 PI 参数设计 (对消逻辑: Ki/Kp = R/L)
% 考虑物理增益 1/L，Kp = L * omega_bw
...
% 目标：引入主动阻尼 (B_active) 压制 130dB 尖峰，再配合 Notch
% ========================================================
%% AMEC 速度环等效对象对比：Active Damping 的真实威力
% 1. 定义基础物理模型
s = tf('s');
