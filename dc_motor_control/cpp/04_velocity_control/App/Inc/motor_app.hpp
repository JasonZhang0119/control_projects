...
private:
    ...
    static constexpr float kSpeedRefStepRadS = 5.0F;
    static constexpr float kSpeedRefMinRadS = -30.0F;
    static constexpr float kSpeedRefMaxRadS = 30.0F;
    ...
    ButtonManager button_manager_{
        KEY_SPEED_DOWN_GPIO_Port,
        KEY_SPEED_DOWN_Pin,
        KEY_SPEED_UP_GPIO_Port,
        KEY_SPEED_UP_Pin
    };
