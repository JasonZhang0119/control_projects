...
void MotorVelocityApp::Initialize()
{
...
void MotorVelocityApp::InitializeSpeedController()
{
    GainMatrix Kp;
    GainMatrix Ki;
    GainMatrix Kd;
...
void MotorVelocityApp::OnGpioExti(const uint16_t gpio_pin)
{
    this->button_manager_.OnExtiInterrupt(gpio_pin);
}


void MotorVelocityApp::HandleButtonEvents()
{
...
uint32_t MotorVelocityApp::ApplySignedDuty(const float signed_duty_permille)
{
...
int32_t MotorVelocityApp::RunSpeedControl(
...
void MotorVelocityApp::LogTelemetry(
