...
#define KEY_SPEED_DOWN_Pin GPIO_PIN_10
#define KEY_SPEED_DOWN_GPIO_Port GPIOB
#define KEY_SPEED_DOWN_EXTI_IRQn EXTI15_10_IRQn
#define KEY_SPEED_UP_Pin GPIO_PIN_11
#define KEY_SPEED_UP_GPIO_Port GPIOB
#define KEY_SPEED_UP_EXTI_IRQn EXTI15_10_IRQn
