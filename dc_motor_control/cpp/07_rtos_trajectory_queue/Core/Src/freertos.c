...
osMessageQId TrajectoryQueueHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the queue(s) */
  /* definition and creation of TrajectoryQueue */
  osMessageQDef(TrajectoryQueue, 32, 4);
  TrajectoryQueueHandle = osMessageCreate(osMessageQ(TrajectoryQueue), NULL);
  ...
  osThreadDef(TrajectoryTask, StartTrajectoryTask, osPriorityIdle, 0, 256);
